...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        '{{ project_name }}.authenticate.TokenAuthenticationHandler',
...
AUTO_SERVER_ENDPOINT = '127.0.0.1:50101'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'default': {
            ...
            'filename': os.path.join(log_path, '{{ project_name }}.log'.format(time.strftime('%Y-%m-%d'))),
